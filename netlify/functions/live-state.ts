...
function buildLiveStateContext({
  ...
  return {
    ...
    contextRules: [
      ...
      "Next Call Preparation is separate from live coaching and cannot trigger a visible-question refresh.",
